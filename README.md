...
За да променяте кода, трябва да инсталирате няколко пакета:
- VS Code
- Node.js
- NPM

За да инсталирате необходимите NPM пакети, отворете терминал и изпълнете

    npm ci

За да можете да стартирате и компилирате кода, отворете терминал и изпълнете

    npm -g @angular/cli

За да стартирате локална сесия за разработка в localhost сесия, стартирайте
